...
public class StormChaser extends FishingRod {
    static int MIN_DURABILITY = 12;
    static int MAX_DURABILITY = 14;

    static int MIN_REELSPEED = 18;
    static int MAX_REELSPEED = 20;

    static int MIN_ACCURACY = 4;
    static int MAX_ACCURACY = 5;

    static int MIN_RANGE = 18;
    static int MAX_RANGE = 20;

    static int MIN_GOLD = 11;
    static int MAX_GOLD = 13;
