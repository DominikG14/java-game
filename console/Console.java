...
public class Console {
    ...
    public static void textSeparator(String text){
        System.out.println();
    ...
    public static void textSeparator(String text, boolean firstSep, boolean lastSep){
        if( firstSep ) System.out.println();
        System.out.print("-----" + text);
        System.out.println("------------------------------");
        if ( lastSep ) System.out.println();
    }
}
